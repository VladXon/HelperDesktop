...
export class SyncScheduler {
  ...
  private options: { league: string; onSyncComplete?: (result: SyncResult) => void; onSyncError?: (error: string) => void };

  constructor(options: { league: string; onSyncComplete?: (result: SyncResult) => void; onSyncError?: (error: string) => void }) {
