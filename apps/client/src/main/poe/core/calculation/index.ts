...
export type { DamageReport, DamageResult } from './damage/damage.types.js';
...
export { calculateArmourMitigation, calculateEvasionChance, calculateEffectiveResistances, calculateBlockChance, calculateRecovery } from './defense/index.js';
